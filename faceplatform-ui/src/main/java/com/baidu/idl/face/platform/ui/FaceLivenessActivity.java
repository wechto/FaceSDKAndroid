...
import com.baidu.idl.face.platform.ui.utils.MySavePicture;
...
// TODO
        requestPermissions(99, Manifest.permission.WRITE_EXTERNAL_STORAGE);
        requestPermissions(99, Manifest.permission.READ_EXTERNAL_STORAGE);
    }
    ...
    private void saveImage(HashMap<String, String> imageMap) {
        ...
        for (Map.Entry<String, String> entry : sets) {
            ...
            if(a==1)
                MySavePicture.viewSaveToImage(bmp);
            if(a==3) {
